    		...
    		<div className="row">
    			<div className="col-sm-12 col-md-6 col-lg-3  d-flex">
    				<div className="product d-flex flex-column">
    					<Link to="#" className="img-prod"><img className="img-fluid" src="assets/images/product-1.png" alt="Colorlib Template"/>
    						<div className="overlay"></div>
    					</Link>
    			...
    			<div className="col-sm-12 col-md-6 col-lg-3  d-flex">
    				<div className="product d-flex flex-column">
    					<Link to="#" className="img-prod"><img className="img-fluid" src="assets/images/product-2.png" alt="Colorlib Template"/>
    			...
    			<div className="col-sm-12 col-md-6 col-lg-3  d-flex">
    				<div className="product">
    					<Link to="#" className="img-prod"><img className="img-fluid" src="assets/images/product-3.png" alt="Colorlib Template"/>
	    					<div className="overlay"></div>
	    				</Link>
    					<div className="text py-3 pb-4 px-3">
    						<div className="d-flex">
    			...
    			<div className="col-sm-12 col-md-6 col-lg-3  d-flex">
    				<div className="product">
    					<Link to="#" className="img-prod"><img className="img-fluid" src="assets/images/product-4.png" alt="Colorlib Template"/>
    						<div className="overlay"></div>
    					</Link>
    					<div className="text py-3 pb-4 px-3">
    						<div className="d-flex">
    			...
    			<div className="col-sm-12 col-md-6 col-lg-3  d-flex">
    				<div className="product d-flex flex-column">
    					<Link to="#" className="img-prod"><img className="img-fluid" src="assets/images/product-5.png" alt="Colorlib Template"/>
    						<div className="overlay"></div>
    					</Link>
    					<div className="text py-3 pb-4 px-3">
    						<div className="d-flex">
    			...
    			<div className="col-sm-12 col-md-6 col-lg-3  d-flex">
    				<div className="product d-flex flex-column">
    					<Link to="#" className="img-prod"><img className="img-fluid" src="assets/images/product-6.png" alt="Colorlib Template"/>
    						<span className="status">50% Off</span>
    						<div className="overlay"></div>
    					</Link>
    					<div className="text py-3 pb-4 px-3">
    			...
    			<div className="col-sm-12 col-md-6 col-lg-3  d-flex">
    				<div className="product">
    					<Link to="#" className="img-prod"><img className="img-fluid" src="assets/images/product-7.png" alt="Colorlib Template"/>
	    					<div className="overlay"></div>
	    				</Link>
    					<div className="text py-3 pb-4 px-3">
    						<div className="d-flex">
    			...
    			<div className="col-sm-12 col-md-6 col-lg-3  d-flex">
    				<div className="product">
    					<Link to="#" className="img-prod"><img className="img-fluid" src="assets/images/product-8.png" alt="Colorlib Template"/>
    						<div className="overlay"></div>
    					</Link>
    					<div className="text py-3 pb-4 px-3">
    						<div className="d-flex">
